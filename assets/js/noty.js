const add = document.querySelector(".add"),
  ...
  audio = new Audio("assets/audios/suc.mp3");
  ...
  notes.forEach((note, idx) => {
    let card = `
        ...
        <div class="menu-app">
            ...
            <ul class="menu">
              <li onclick="editNote(${idx}, '${note.title}', '${note.description}')"><i class="fa fa-edit"></i> تعديل</li>
              <li onclick="removeNote(${idx})"><i class="fa fa-trash-alt"></i> حذف</li>
            </ul>
          </div>
        </div>
      </div>
